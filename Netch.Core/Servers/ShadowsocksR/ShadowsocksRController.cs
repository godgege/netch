...
public class ShadowsocksRController : Guard, IServerController
{
    ...
    public ShadowsocksRController(NetchAppContext appContext) : base(appContext, "ShadowsocksR.exe")
    {
    ...
    public async Task<Socks5Server> StartAsync(Server s)
    {
        ...
        var arguments = new object?[]
        {
            ...
            "-o", server.OBFS,
            "-g", server.OBFSParam,
            "-b", this.GetLocalAddress(_appContext.Settings.LocalAddress),
            "-l", this.GetSocks5LocalPort(_appContext.Settings.Socks5LocalPort),
