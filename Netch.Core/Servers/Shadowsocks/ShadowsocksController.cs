...
public class ShadowsocksController : Guard, IServerController
{
    ...
    public ShadowsocksController(NetchAppContext appContext) : base(appContext, "Shadowsocks.exe", encoding: Encoding.UTF8)
    {
    ...
    public async Task<Socks5Server> StartAsync(Server s)
    {
        ...
        var arguments = new object?[]
        {
            ...
            "-b", $"{this.GetLocalAddress(_appContext.Settings.LocalAddress)}:{this.GetSocks5LocalPort(_appContext.Settings.Socks5LocalPort)}",
