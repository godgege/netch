...
{
    public static async Task<NatTypeTestResult> DiscoveryNatTypeAsync(Socks5Server socks5, string stunServerHost, ushort stunServerPort, CancellationToken ctx = default)
    {
        var stunServer = stunServerHost;
        var port = stunServerPort;
