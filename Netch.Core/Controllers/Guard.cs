...
public abstract class Guard
{
    ...
    /// <param name="appContext">application context providing NetchDir and Job</param>
    ...
    protected Guard(NetchAppContext appContext, string mainFile, bool redirectOutput = true, Encoding? encoding = null)
    {
        ...
        Instance = new Process
        {
            ...
            {
                FileName = fileName,
                WorkingDirectory = $"{_appContext.NetchDir}\\bin",
                CreateNoWindow = true,
    ...
    protected string LogPath => Path.Combine(_appContext.NetchDir, $"logging\\{Name}.log");
    ...
    protected async Task StartGuardAsync(string argument, ProcessPriorityClass priority = ProcessPriorityClass.Normal)
    {
        ...
        Instance.Start();
        _appContext.Job.AddProcess(Instance);
