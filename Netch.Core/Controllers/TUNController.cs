...
namespace Netch.Controllers
{
    public class TUNController : IModeController
    {
        ...
        private readonly DNSController _aioDnsController;
        ...
        public TUNController(NetchAppContext appContext, IStatusReporter statusReporter)
        {
            _appContext = appContext;
            _statusReporter = statusReporter;
            _aioDnsController = new DNSController(appContext);
        }
        ...
        public async Task StartAsync(Socks5Server server, Mode mode)
        {
            ...
            _mode = tunMode;
            _tunConfig = _appContext.Settings.TUNTAP;
            ...
            else
            {
                ...
                Dial(NameList.TYPE_DNSADDR, $"127.0.0.1:{_appContext.Settings.AioDNS.ListenPort}");
            }
        ...
        {
            string binDriver = Path.Combine(_appContext.NetchDir, Constants.WintunDllFile);
        ...
        {
            _statusReporter.ReportStatus(i18N.Translate("Setup Route Table Rule"));
            ...
            {
                RouteUtils.CreateRoute(_outbound.FillTemplate(Utils.Utils.GetHostFromUri(_appContext.Settings.AioDNS.ChinaDNS), 32));
                RouteUtils.CreateRoute(_tun.FillTemplate(Utils.Utils.GetHostFromUri(_appContext.Settings.AioDNS.OtherDNS), 32));
            }
        ...
        private void ClearRouteTable()
        {
            ...
            {
                RouteUtils.DeleteRouteFill(_outbound, _appContext.Settings.TUNTAP.BypassIPs);
                RouteUtils.DeleteRoute(_outbound.FillTemplate(Utils.Utils.GetHostFromUri(_appContext.Settings.AioDNS.ChinaDNS), 32));
