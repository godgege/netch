...
public class NFController : IModeController
{
    ...
    public NFController(NetchAppContext appContext, IStatusReporter statusReporter)
    {
    ...
    public async Task StartAsync(Socks5Server server, Mode mode)
    {
        ...
        _server = server;
        _mode = processMode;
        _rdrConfig = _appContext.Settings.Redirector;
    ...
    private void DialRule()
    {
        ...
        // Bypass Self
        Dial(NameList.AIO_BYPNAME, "^" + _appContext.NetchDir.ToRegexString());
    }
    ...
    private void InstallDriver()
    {
        ...
        _statusReporter.ReportStatus(i18N.Translate("Installing netfilter2 driver"));
